...
" court composer, to follow Ariel and keep ", a_her, " out of trouble.\n\nLater that day, Ariel slipped away again, with ", Sebastian,
...
" couldn\'t forget the human ", prince, ". As ", a_she, " sat thinking about ", e_him, ", two evil eels named Flotsam and Jetsam watched ", a_her,
...
" told the young ", mermaid, " that ", u_she, " could help ", a_her, " visit ", e_him, " - for a price!\n\n\"I will make you human so you can visit your young ",
...
" two friends rushed ", a_her, " up to the surface so ", a_her, " could breathe.\n", Ursula, " cackled with glee. ", u_She,
...
girl, " who had saved ", e_his, " life. Although ", e_he, " hadn\'t seen ", a_her, ", ", e_he, " had fallen in love with ", a_her, " wonderful voice. ",
Eric, " would have given ", e_his, " entire kingdom to find ", a_her, "! Then, as ", e_he, " was walking with Max, ", e_he,
" saw Ariel on the beach.\n\"Have we met before?\" ", Eric, " asked, ", e_his, " heart skipping a beat. But ", e_his, " hopes were soon dashed when ", e_he,
" found that Ariel could not speak. ", a_She, " can\'t be the one, ", e_he, " thought.\n\nStill, the ", prince, " felt sorry for Ariel, so ", e_he,
" brought ", a_her, " to ", e_his, " castle. ", e_His, " servants fed ", a_her, " and gave ", a_her, " nice clothes to wear.\n\nThe next day, the ", prince,
" took Ariel for a coach ride through ", e_his, " kingdom. \"", a_She, "\'s so lovely,\" ", Eric, " said to ", himself, ". \"If only ", a_she, " were the ",
girl, " I\'ve been searching for!\"\n\nThe next day, the ", prince, " took Ariel for a boat ride.\nThere isn\'t much time, thought Ariel. If ", e_he,
...
" walked along the beach, the sound of Ariel\'s beautiful voice filled the air. ", Eric, " could hardly believe ", e_his, " ears! The ", girl,
" who had saved ", e_his, " life had finally come back to ", e_him, "!\nQuickly, the Sea ", Witch, " put a spell on ", Eric, ", and ", e_he,
" decided to marry ", u_her, " right away.\n\n", Ursula, "\'s nasty trick had worked. ", u_She, " and ", Eric, " were to be married on ", e_his,
" ship that very day!\nIn ", u_her, " cabin, ", Ursula, " laughed as ", u_she, " looked at ", u_her, " true reflection in the mirror. Luckily, Scuttle saw ",
Ursula, "\'s real reflection, too.\n\nScuttle and Flounder rushed off to find Ariel and tell ", a_her, " all about the Sea ", Witch,
"\'s latest trick.\n\"Don\'t worry, Ariel. We\'ll help you!\" said Scuttle, as Flounder pulled ", a_her,
...
Ursula, "\'s clothing and pulled ", u_her, " hair. The seashell fell from ", Ursula, "\'s neck. When it broke, Ariel\'s voice returned to ", a_her,
...
" to ", e_him, ", trying to protect ", a_her, " from the ", witch, "\'s fury.\n\n", Eric, " knew ", e_he,
...
" granted Ariel ", a_her, " dearest wish - ", t_he, " made ", a_her, " human again.\n\nTriton watched as ", Eric,
" and Ariel walked back to the castle.\n\"I\'m going to miss ", a_her, ",\" ", King, " Triton said to ", Sebastian,
